        ...
        <div style="overflow:hidden;">
            ...
            <div id="slideBox_1" class="slideBox_1 slideBox">
                ...
                <div class="bd"><a href="javascript:;" class="prev"></a><a href="javascript:;" class="next"></a>
                    <ul>
                        <li style="display: none;"><a href="javascript:void(0);"><img src="__PUBLIC__/site/{$Think.THEME_NAME}/images/slideBox/slide01.jpg"></a>
                        </li>
                        <li style="display: list-item;"><a href="javascript:void(0);"><img src="__PUBLIC__/site/{$Think.THEME_NAME}/images/slideBox/slide02.jpg"></a></li>
                        <li style="display: none;"><a href="javascript:void(0);"><img src="__PUBLIC__/site/{$Think.THEME_NAME}/images/slideBox/slide03.jpg"></a>
                        </li>
                    </ul>
                </div>
            </div>
